...
import 'package:cinema_pedia/presentation/providers/movies/movies_detail_info.dart';
...
class MovieScreenState extends ConsumerState<MovieScreen> {
  ...
  void initState() {
    ...
    ref.read( actorsByProvider.notifier ).loadActors(widget.movieId);
...
class _ActorByMovie extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    ...
    final actorByMovie = ref.watch( actorsByProvider );
            ...
            const SizedBox.expand(
              child: DecoratedBox(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    stops: [0.7, 1.0 ], // empiece en el 70% y termino en el 10%
             ...
             const SizedBox.expand(
              child: DecoratedBox(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    stops: [0.0, 0.3], // empiece en el 70% y termino en el 10%
